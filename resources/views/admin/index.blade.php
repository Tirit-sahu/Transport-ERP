...
<!-- 
   <div class="col-sm-12">
						<div class="box box-bordered box-color satblue">
							...
							<div class="box-title">
								<h3>
									<i class="fa fa-bars"></i>Master Loading Entry Form</h3>
							</div>
							<div class="box-content nopadding">
                         ...
                         -->            
                               <form action="{{url('/')}}/admin/dispatch/load" id="form" autocomplete="off" method="post" class='form-vertical' enctype="multipart/form-data">
									...
									<div class="row">
										...
										<div class="col-sm-2">
											<div class="form-group">
												<label for="textfield" class="control-label"><strong>Item Master <span class="err" style="color:#F00;">*</span> </strong> <img src="{{url('/')}}/admin/add.png" id="shortcut_truck" data-toggle="modal" data-target="#new-task"></label>
										...
										<div class="col-sm-2">
											<div class="form-group">
											<label for="textfield" class="control-label"><strong>Case Advance</strong></label>
												<input type="text" name="case_advance" id="case_advance" 
                                                placeholder="Case Advance" class="form-control">
											</div>
										</div>

										<div class="col-sm-2">
											<div class="form-group">
												<label for="textfield" class="control-label"><strong>Hemal <span class="err" style="color:#F00;">*</span> </strong> <img src="{{url('/')}}/admin/add.png" id="shortcut_truck" data-toggle="modal" data-target="#new-task"></label>
										...
										<label for="textfield" class="control-label"><strong>BAGS</strong></label>
												<input type="text" name="bags" id="bags"  value="@yield('bags')" class="form-control">
											</div>
										</div>
                                        <div class="col-sm-2">
											<div class="form-group">
												<label for="textfield" class="control-label"><strong>FRIGHT RATE</strong>  </label>
												<input type="text" name="fright_rate" id="fright_rate" value="@yield('fright_rate')" class="form-control">
											</div>
										</div>
...
<label for="textfield" class="control-label"><strong>CASH ADVANCE</strong></label>
                                         ...
                                         <div class="col-sm-12">
											<div class="form-group">
                                     <center> 
                                    <button class="btn btn-satgreen">Save</button>
...
<tr>
	...
	<td>
		<a href="{{route('load.show',$load->id)}}" class="btn" rel="tooltip" title="Print">
									...
									<div class="top">
										<div class="left" style="width:250px;">
											<select name="category" onchange="search_truck_docs();" class='chosen-select' id="search_truck_docs"  style="width:250px;">
												<option value="">Select</option>
												<option value="1">Permit Alerts</option>
												<option value="2">Insurance Alerts</option>
												<option value="3">Fitness Alerts</option>
												<option value="4">National Permit Alerts</option>
                                                <option value="5">Road Tax Alerts</option>
                                                <option value="6">Pollution Alerts</option>
                                                <option value="7">Khanij Registration </option>
