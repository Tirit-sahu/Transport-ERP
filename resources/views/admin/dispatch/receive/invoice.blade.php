  ...
  <tr>
   ...
   <tr>
      <td colspan="2" rowspan="2" style="padding-left:  4px;">  {{ $load->Consignor->consignor_name }} 
       ...
       <br><span>GST : {{ $load->Consignor->consignor_gst_no }}</span></td>
   ...
   <tr>
      <td colspan="2">Truck No : {{$load->truck->truck_number}}</td>
   </tr>
   <tr>
   ...
   <tr>
      ...
      <td colspan="2" rowspan="4">Owner Name &amp; Address : {{ $load->truck->truckOwner->owner_name }} </br> {{ $load->truck->truckOwner->address }} </td>
   </tr>
